...
import * as votingView from "./js/ui/voting-view.js";
import * as resultsView from "./js/ui/results-view.js";

const views = [lobbyView, roleRevealView, guessingView, votingView, resultsView];
